...
(() => {
    ...
    class NewsletterTable {
        ...
        constructor() {
            ...
            this.#perPage = window.eimRestorePerPage(this.#perPageSel, 'eim_per_page_newsletters', 10, () => this.#refresh());

            this.#perPageSel?.addEventListener('change', () => {
                this.#perPage = Number(this.#perPageSel.value);
                window.eimPersistPerPage('eim_per_page_newsletters', this.#perPage);
                this.#page = 1;
                this.#refresh();
            });
